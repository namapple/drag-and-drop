...
namespace I2.Loc
{
	...
	public class LocalizeInspector : Editor
	{
		...
		SerializedProperty 	mProp_mTerm, mProp_mTermSecondary,
                            ...
                            mProp_CallbackEvent, mProp_DisableBestFit;
		...
		void OnEnable()
		{
			...
			mProp_DisableBestFit        	= serializedObject.FindProperty("DisableBestFit");
				...
				{ 
					GUILayout.BeginVertical("Box");
                        ...
                        //GUILayout.EndHorizontal();
						{
							...
							GUILayout.FlexibleSpace();
						    mProp_DisableBestFit.boolValue = GUILayout.Toggle(mProp_DisableBestFit.boolValue, new GUIContent("Disable BestFit", "Disable bestfit for specific country"));
						    GUILayout.EndHorizontal();
						}
