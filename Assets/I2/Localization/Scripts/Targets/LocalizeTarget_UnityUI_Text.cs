...
//--[ Localize Font Object ]----------
			...
			if(cmp.DisableBestFit)
			{
				if(LocalizationManager.CurrentLanguage.Equals("Japanese") || LocalizationManager.CurrentLanguage.Equals("Chinese") || LocalizationManager.CurrentLanguage.Equals("Thai"))
				{
					mTarget.resizeTextForBestFit = false;
				}
				else
				{
					mTarget.resizeTextForBestFit = true;
				}
			}
